...
export default class ConfigProviderBuilder {
  ...
  configProviderFactoryFunction: (...dependencies: any) => ConfigProvider;

  profileNames: Array<string>;

  constructor(configProviderFactoryFunction: ConfigProviderFactoryFunction, container: Container) {
