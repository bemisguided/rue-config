 ...
 * @flow
 */
import { PreInjectionFilter } from 'rue';
import ConfigPropertyHelper from '../utils/ConfigPropertyHelper';
import ConfigProvider from './ConfigProvider';

export default class ConfigPreInjectionFilter extends PreInjectionFilter {

  filter(targetName: string, dependencyName: string, instance: ConfigProvider): any {
